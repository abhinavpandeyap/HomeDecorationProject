                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div className="d-flex">
                                ...
                                <div className="ml-3">
                                    <h4 className="px-2 text-warning">{item.pname}</h4>
                                    <h5 className="px-2">Brand: {item.brand}</h5>
                                    <h5 className="px-2">Category: {item.pcat}</h5>
                                    <h5 className="px-2" hidden>Sellerid: {item.sellerId}</h5>
                                    <h5 className="px-2">Seller: {item.sellerName}</h5>
                                    <h5 className="px-2">Price: &#8377; {item.price}</h5>
                                    <h5 className="px-2">Qty: <input className="form-control" type="number" min="1" max="100" value={qty} onChange={e=>setQty(e.target.value)}/></h5>
