...
function ViewCart(){
    ...
    useEffect(()=>{
        let amount=state.cart.reduce((a,b)=> ((a+b.price)*(b.qty)),0)
    ...
    return (
        ...
        <div className="container-fluid text-black">
            ...
            <div className="">     
            <form className="bg-secondary text-center text-white p-3" onSubmit={handleSubmit} >           
                <h5 className="p-2">Address Information</h5>
                <div className="form-group form-row">
                    <label className="col-sm-4 text-white form-control-label">City</label>
